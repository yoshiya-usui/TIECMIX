...
**Calc_kappa_Crack.py** calculates the hyperparameter kappa and crack volume fraction from the ratio sigma_x/sigma_z (variable "ans" in the script).
...
**Calc_kappa_Tube.py** calculates the hyperparameter kappa and tube volume fraction from the ratio sigma_x/sigma_z (variable "ans" in the script).
